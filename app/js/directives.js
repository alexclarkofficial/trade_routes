...
angular.module('tradeRoutesApp').directive('navbar', function() {
  return {
    restrict: 'E',
...
angular.module('tradeRoutesApp').directive('xref', function($route, $location, $window){
	return {
		// restrict: 'A',
...
angular.module('tradeRoutesApp').directive('fitVids', [function() {
    'use strict';
